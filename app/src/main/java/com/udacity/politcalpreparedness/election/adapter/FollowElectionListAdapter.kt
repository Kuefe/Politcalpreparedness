...
import com.udacity.politcalpreparedness.databinding.ListViewItemFollowBinding
...
class FollowElectionListAdapter(val onClickListener: OnClickListener) :
    ListAdapter<Election, FollowElectionListAdapter.ElectionViewHolder>(DiffCallback) {
     ...
     */
    class ElectionViewHolder(private var binding: ListViewItemFollowBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(item: Election) {
            binding.followElection = item
    ...
    override fun onCreateViewHolder(
        ...
        return ElectionViewHolder(
            ListViewItemFollowBinding.inflate(
